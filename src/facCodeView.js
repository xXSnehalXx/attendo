...
export default class FacCodeView extends Component {
  ...
  submitButtonPressed = () => {
    if (this.state.facCode != "") {
      ...
      value =
        value +
        `,'${this.state.n}','${this.state.facCode}','${this.state.id}')`;
  ...
  render() {
    ...
    if (this.state.status == "success")
      tex = (
        <Text style={[styles.buttText, { color: "green" }]}>
          Attendance taken
        </Text>
      );
    else if (this.state.status == "wrong")
      tex = (
        <Text style={[styles.buttText, { color: "red" }]}>Wrong password</Text>
      );
    return (
        ...
        <View style={styles.box}>
          ...
          <View style={styles.row}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={styles.buttTextContainer}>
                <Text style={[styles.buttText, { color: "blue" }]}>Cancel</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <View style={styles.buttTextContainer}>
                <Text style={[styles.buttText, { color: "blue" }]}>Submit</Text>
              </View>
            </TouchableOpacity>
          </View>
          <View style={styles.row} />
